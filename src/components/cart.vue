<template>
  <div class="row">
    <div class="col col-md-8">
      ...
      <div
        class="row my-3 px-2 border-top border-bottom border-gray shadow p-3 rounded-3 tarjetitas"
      ...
      >
        <div v-if="producto.cliente_id === cliente.id">
          ...
          <div class="col-12 mx-3 d-flex justify-content-center align-items-end flex-column px-4">
            ...
            <p>
              <b class="border-bottom border-gray">Precio por unidad:</b> {{ producto.precio }}€
            </p>

            <!-- Nuevo párrafo para mostrar el precio total -->
            <p>
              <b class="border-bottom border-gray">Precio total:</b>
          ...
          <div class="col-3 d-flex flex-column justify-content-center align-items-center">
            <button
              @click="feliminarProducto(producto.id)"
              class="mb-2 my-2 btn btn-danger d-inline"
            >
              Eliminar
            </button>
